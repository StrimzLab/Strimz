...
const buttonVariants = cva(
  [
    'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-poppins text-sm font-[500]',
  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-[#F9FAFB] text-[#050020] border border-[#E5E7EB] hover:bg-white hover:border-[#050020]',
        outline:
