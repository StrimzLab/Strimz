...
export class AnalyticsController {
  ...
  conversion(
    ...
    return this.analytics.conversion(ctx.merchantId, { from, to })
  }
  ...
  ltv(
    ...
    return this.analytics.ltv(ctx.merchantId, {
