...
The server SDK is what you'll spend most of your time with. It's typed, validated with Zod, and retries 5xx and 429 responses automatically.
...
const strimz = new Strimz({
  ...
  baseUrl: 'https://api.strimz.io',  // optional override; defaults to live
  timeout: 30_000,
  retries: 3,
})
```
