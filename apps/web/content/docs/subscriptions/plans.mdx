...
You send this to anyone you want to subscribe. The page handles wallet connect, the EIP-2612 permit signature, and the first-cycle charge in one prompt. Same UX as one-shot hosted checkout; one signature.
