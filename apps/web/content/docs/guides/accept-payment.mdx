...
That's the entire client side. The customer lands on `strimz.finance/pay/<sessionId>`, connects a wallet (any major one — Reown handles the picker), and signs the payment.
