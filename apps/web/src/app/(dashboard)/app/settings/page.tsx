    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="profile">
        ...
        <TabsContent value="profile" className="mt-4 space-y-4">
          ...
          <SettingsCard
            title="Security"
            description="Two-factor authentication is enforced by Privy."
          >
            <div className="border-border/60 flex items-center justify-between rounded-md border p-3">
              <div className="text-sm">
                ...
                <div className="text-muted-foreground text-xs">
                  Required to issue or rotate live-mode keys.
                </div>
              </div>
              <Badge
                variant="outline"
                className="border-[#02C76A]/40 bg-[#02C76A]/10 text-[#02C76A]"
              >
                Active
              </Badge>
            </div>
        ...
        <TabsContent value="business" className="mt-4 space-y-4">
          ...
          >
            ...
            <Field
              ...
              id="biz-addr"
              defaultValue="20 Chancery Lane, London, EC4A 1LF"
            />
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="grid gap-1.5">
                <Label htmlFor="biz-sector">Sector</Label>
                <Select defaultValue="saas">
                  <SelectTrigger id="biz-sector">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
        ...
        <TabsContent value="payout" className="mt-4 space-y-4">
          <SettingsCard
            title="Payout wallet"
            description="USDC lands in this wallet whenever a customer pays you. Changing it requires an on-chain confirmation."
          >
            <div className="grid gap-1.5">
              <Label htmlFor="payout-wallet">Payout wallet (Arc)</Label>
              <Input
                id="payout-wallet"
                defaultValue="0x742d35Cc6634C0532925a3b844Bc9e7595f8b1A2"
                className="font-mono"
              />
        ...
        <TabsContent value="notifications" className="mt-4 space-y-4">
          <SettingsCard title="Email notifications" description="Pick what shows up in your inbox.">
            <ToggleRow
              id="notif-digest"
              label="Daily cashflow digest"
              desc="Yesterday's gross, fees, net, customers."
              defaultChecked
            />
            <ToggleRow
              id="notif-anomaly"
              label="Cashflow anomaly alerts"
              desc="When hourly revenue drops > 2σ from baseline."
              defaultChecked
            />
            <ToggleRow
              id="notif-failed"
              label="Subscription charge failed"
              desc="One per failed charge."
              defaultChecked
            />
            <ToggleRow
              id="notif-webhook"
              label="Webhook endpoint disabled"
              desc="Auto-fired after 5+ permanent failures."
              defaultChecked
            />
            <ToggleRow
              id="notif-monthly"
              label="Monthly pricing intelligence"
              desc="MRR, churn, 90-day forecast on the 1st of each month."
              defaultChecked
            />
            <ToggleRow
              id="notif-product"
              label="Product updates"
              desc="New features, breaking changes."
            />
            <SaveBar />
          </SettingsCard>
        </TabsContent>
          ...
          <SettingsCard title="Team" description="Invite teammates with scoped roles.">
            <div className="space-y-2">
              {[
                ...
                <div
                  key={m.email}
                  className="border-border/60 flex items-center justify-between rounded-md border px-3 py-2.5"
                >
            ...
            <div className="border-border/60 grid gap-3 rounded-md border border-dashed p-4 sm:grid-cols-[1fr_140px_120px]">
            ...
            <div className="border-border/60 rounded-md border p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-muted-foreground text-xs">
                    0.5% per transaction · up to $50k / mo
                  </div>
                </div>
                <Badge
                  variant="outline"
